      ...
      <div className="relative w-full  rounded-sm max-w-xl max-h-[85vh] flex flex-col bg-white dark:bg-[#060b18] ow-2xl overflow-hidden border border-emerald-900/20 animate-in zoom-in-95">
        ...
        <form className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              className="w-full min-h-[90px] p-4 rounded-sm bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-sm outline-none focus:border-emerald-500 resize-none"
