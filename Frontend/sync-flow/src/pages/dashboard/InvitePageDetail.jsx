              ...
              <div className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-2xl overflow-hidden group transition-all focus-within:ring-2 ring-blue-500/20">
                    <input
                      readOnly
                      value={datas.invite_url}
                      className="flex-1 bg-transparent py-4 px-5 text-sm font-bold dark:text-slate-200 focus:outline-none"
                    />
                    <button
                      onClick={handleCopy}
                      className="px-5 text-blue-600 dark:text-blue-400 hover:bg-blue-500/10 transition-all border-l border-slate-200 dark:border-white/5"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                      <span className="text-[9px] font-bold text-slate-400 uppercase block mb-1 tracking-widest">
                        Token
                      </span>
